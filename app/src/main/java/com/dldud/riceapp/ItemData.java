...
public class ItemData {
    ...
    String strVideo;
    String strUserName;
    String strDistance;  //거리 차 계산해서 값 입력용
    int pingLike;
    int pingReply;
    double pingDistance;    //거리 차 계산해서 ping 정렬용
    ...
    public void setPingReply(int pingReply){
    ...
    public void setPingLike(String strPingLike){
        this.pingLike = pingLike;
    }
    ...
    public void setPingDistance(double pingDistance){
        this.pingDistance = pingDistance;
    }

    String getStrDistance(){
        return strDistance;
    }
